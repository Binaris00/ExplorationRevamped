...
public class SuperPoweredRail extends AbstractRailBlock {
    public static final MapCodec<SuperPoweredRail> CODEC = createCodec(SuperPoweredRail::new);
    public static final EnumProperty<RailShape> SHAPE = Properties.STRAIGHT_RAIL_SHAPE;
    public static final BooleanProperty POWERED = Properties.POWERED;


    public SuperPoweredRail(Settings settings) {
        super(true, settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(SHAPE, RailShape.NORTH_SOUTH).with(WATERLOGGED, Boolean.valueOf(false)).with(POWERED, Boolean.valueOf(false)));
    }
    ...
    protected boolean isPoweredByOtherRails(World world, BlockPos pos, BlockState state, boolean bl, int distance) {
        if (distance >= 8) {
            ...
            return this.isPoweredByOtherRails(world, new BlockPos(i, j, k), bl, distance, railShape) || bl2 && this.isPoweredByOtherRails(world, new BlockPos(i, j - 1, k), bl, distance, railShape);
        }
    }
